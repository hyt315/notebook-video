...
- **v2.9.0（当前）**：主线版本。已吸收早期 v2.9 / v3.0 两条试验线的优点（受限镜头配方、内容路由、结构化分镜表），并修复了它们各自的问题（v2.9 删掉了强制条款导致成片变空、v3.0 用"限量文本"换稳定性导致表达被压扁）。**v2.9 / v3.0 两条分支与它们的旧 tag 已删除，只保留 `main`。**
